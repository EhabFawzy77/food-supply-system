...
export default function DashboardHome() {
  ...
  const StatCard = ({ icon: Icon, label, value, color, link }) => (
    <Link href={link}>
      <div className={`group bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-3 border-l-4 ${color} hover:translate-y-[-2px]`}>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-50 to-indigo-50 p-3 md:p-4" dir="rtl">
      <div className="max-w-7xl mx-auto">

        {/* Main Stats */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3 mb-4">
          <StatCard
            icon={DollarSign}
            label="مبيعات اليوم"
              ...
              {stats.customersWithDebt > 0 && (
                <Link href="/dashboard/customers">
                  <div className="p-3 bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-lg hover:shadow-md transition cursor-pointer group">
                    <div className="flex items-start gap-2">
                      <Users className="w-3 h-3 text-orange-600 flex-shrink-0 mt-0.5" />
                      <div className="flex-1">
              ...
              {(stats.payments?.pendingPayments || 0) > 0 && (
                <Link href="/dashboard/payments">
                  <div className="p-3 bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-lg hover:shadow-md transition cursor-pointer group">
                    <div className="flex items-start gap-2">
                      <CreditCard className="w-3 h-3 text-blue-600 flex-shrink-0 mt-0.5" />
                      <div className="flex-1">
