    ...
    <div className="min-h-screen bg-gray-50 p-6" dir="rtl">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <p className="text-gray-600 mt-2">إدارة المبيعات والفواتير</p>
        </div>
                  ...
                  <div key={item._id} className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        className="w-6 h-6 bg-gray-200 text-gray-600 rounded hover:bg-gray-300 flex items-center justify-center"
                      >
                ...
                <div className="space-y-2 border-b pb-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <input
                      ...
                      className="w-24 px-3 py-1 border border-gray-300 rounded-lg text-left text-sm"
                      placeholder="0"
                    />
                  </div>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg p-8 max-w-md w-full max-h-96 overflow-y-auto">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm">{lastInvoice.invoiceNumber}</p>
              </div>

              <div className="space-y-3 mb-6 text-sm border-b pb-4">
                <div className="flex justify-between">
                  <span className="text-gray-600">التاريخ:</span>
                  <span className="font-semibold">{lastInvoice.date}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">العميل:</span>
                  <span className="font-semibold">{lastInvoice.customer}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">المجموع:</span>
                  <span className="font-semibold text-indigo-600">{lastInvoice.total.toLocaleString()} جنيه</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">طريقة الدفع:</span>
                  <span className="font-semibold">{translatePayment(lastInvoice.paymentMethod)}</span>
                </div>
                {lastInvoice.change > 0 && (
                  <div className="flex justify-between text-green-600">
                    <span>الباقي:</span>
                    <span className="font-semibold">{lastInvoice.change.toLocaleString()} جنيه</span>
                  </div>
                )}
              </div>
